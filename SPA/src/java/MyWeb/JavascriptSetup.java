...
public class JavascriptSetup {
    ...
    public static String getFileContent(String path, StringBuffer sb) throws FileNotFoundException {
    ...
    public static void setFileContent(String path, String str, Boolean buildFolder) throws UnsupportedEncodingException {
        if (!buildFolder) {
            path = FoldersHelper.getSrcJavaFolder() + path;
        } else {
    ...
    private static List<String> getJsFilePathsForPackages(List<String> packagePaths) throws UnsupportedEncodingException {
        ...
        for (String packagePath : packagePaths) {
            ...
            File directoryProjectFolder = new File(FoldersHelper.getSrcJavaFolder());
    ...
    public static void clearScriptsList() throws UnsupportedEncodingException {
        ...
        Settings settings = new Settings(FoldersHelper.getSrcJavaFolder() + "/MyWeb/scripts_list.bin");
    ...
    public static List<String> getJsFilePathsInOrderOfDependancy(String rootScript, String type, InterfaceConfiguration interfaceConfiguration) throws UnsupportedEncodingException, Exception {
        ...
        System.out.println("getJsFilePathsInOrderOfDependancy");
        Settings settings = new Settings(FoldersHelper.getSrcJavaFolder() + "/MyWeb/scripts_list.bin");
        ...
        System.out.println("about to do file paths");
        List<String> filePaths = getFilesInFolders(interfaceConfiguration.getJsFolders());
        ...
        for (String filePath : filePaths) {
            System.out.println("Linting: "+filePath);
    ...
    private static List<String> getFilesInFolders(List<String> folders) throws UnsupportedEncodingException {
        List<String> returns = new ArrayList<String>();
        String srcFolder=FoldersHelper.getSrcFolder();
        for (String folder : folders) {
            System.out.println("Searching Folder: ");
            File[] files = new File(srcFolder+folder).listFiles();
            for (File file : files) {
                String path = file.getPath();
                if (path.toLowerCase().substring(path.length() - 3, path.length()).equals(".js")) {
    ...
    public static String getCompleteChatJavaScript(String pointedToFileNameString, Boolean isDevelopmentMachine, InterfaceConfiguration interfaceConfiguration) throws FileNotFoundException, UnsupportedEncodingException {
        System.out.println("getCompleteChatJavaScript"); 
       StringBuffer sb = new StringBuffer();

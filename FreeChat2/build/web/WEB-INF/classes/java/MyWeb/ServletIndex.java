...
public class ServletIndex extends HttpServlet {
    ...
    private String getJsFileName(Boolean isMobile, Boolean push, Boolean redoIfDone, String pageType, String pageUrl) {
    ...
    private String getIndexBody(Boolean isMobile, String pageType, String pageUrl) {
        ...
        if (pageType.contains("all")) {
            ...
            Iterator<Room> iterator = Rooms.openOnEnter.iterator();
            JSONArray openOnEnter = new JSONArray();
            while (iterator.hasNext()) {
                Room room = iterator.next();
                try {
                    openOnEnter.put(room.getJSONObject());

...
function ProfilePicture(params)
{
    ...
    if (url)
    {
        ...
        console.log('none');
        console.log(params.userUuid);
		if(params.userUuid)
			url = 'profile_image/'+params.userUuid;
     }
    instances.push(this);
...
function Users(independant, cssName, userInformation, callbackEntered, callbackLeft, callbackProfilePicture)
{
    ...
    function UserEntry(r)
    {
        ...
        var profilePicture = new ProfilePicture({userName:r.name});
...
function Message(params)
{
    ...
    function getDivUsername(user){
        ...
        new HoverAndClick(div, function(){div.style.textDecoration = 'underline';}, function(){}, function(e){
            console.log(userInformation);
            if(userInformation&&params.userUuid!=userInformation.userUuid)

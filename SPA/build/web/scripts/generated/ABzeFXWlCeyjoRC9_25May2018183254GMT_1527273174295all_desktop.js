...
function Notifications()
{
    ...
    this.taskBarInformation = {tooltip: 'Notifications', icon: ('images/notifications-icon.gif'), style: {backgroundColor: 'transparent'}, hoverStyle: {backgroundColor: 'rgba(0,255,255, 0.5)'}, activeStyle: {backgroundColor: 'rgba(0, 128, 255, 0.5)'}};
    this.div = document.createElement('div');
    var divInner = document.createElement('div');
    var divTab = document.createElement('div');
    var divName = document.createElement('div');
        ...
        for (var i = notifications.length - 1; i >= 0; i--)
        {
            ...
            if (r.roomUuid)
            {
                if (!mapIdToNotificationEntry[r.roomUuid])
                {
                    ...
                    var j = 0;
                    var inserted = false;
                    var lowerCaseName = notificationEntry.info.name.toLowerCase();
                    while (j < arrayRoomEntries.length)
                    {
                        var rEntry = arrayRoomEntries[j];
                        if (rEntry.info.name.toLowerCase() > lowerCaseName)
                        {
                            ...
                            arrayRoomEntries.splice(j, 0, notificationEntry);
                    ...
                    {
                        mapIdToNotificationEntry[r.roomUuid] = notificationEntry;
                        arrayRoomEntries.push(notificationEntry);

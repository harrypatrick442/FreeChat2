...
function GenericWindow(params)
{
    ...
    var callbackMinimize = minimizable ? function () {
        self.task.minimize();dispatchMinimizeEvent();
    } : function () {
    };
    var callbackMaximize = maximizable ? function () {
        self.task.maximize(); dispatchMaximizeEvent();
    } : function () {
    };
...
function LocationPicker(messenger) {
    ...
    autocompleteInput.style.width='100px';
    autocompleteInput.style.minWidth = '100px';

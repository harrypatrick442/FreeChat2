...
function Authenticate(callbackSignIn, callbackRegister, enableAge)
{
    ...
    if (enablePassword) {
        ...
        textUsernameRegister.className='form-control input-sm';
        textEmailRegister.className='form-control input-sm';
        textPasswordReenterRegister.className='form-control input-sm';
        textPasswordRegister.className='form-control input-sm';
        ...
        divInputsRegister.className='form-group';

...
Windows.add = function(obj, minimized, divTab, divInner, windowInformation, callbacks)
{
    ...
    if (!isMobile)
    {
        obj.buttonClose = new self.CloseButton(function() {
        ...
        {
            obj.buttonMaximize = new self.MaximizeButton(function() {
        ...
        {
            obj.buttonMinimize = new self.MinimizeButton(function() {
                if (callbacks.minimize)
                    callbacks.minimize();
            });
...
this.maximize = function(obj, fillElseReduce)
{
  ...
  console.log(err.stack);
               ...
               console.log(windowInformation.previousSizes);
        var p = Resizable.padding * 2;

function LocationPicker() {
    ...
    var autocomplete;
    var genericWindow = new GenericWindow(/*name*/'Location picker', /*tooltipMessage*/'Used to pick location', /*iconPath*/'images/location_picker.jpg', /*minWidth*/150, /*maxWidth*/1000, /*minHeight*/200, /*maxHeight*/1000, /*defaultWidth*/500, /*defaultHeight*/500, /*defaultX*/200, /*defaultY*/200, /*minimized*/false, /*minimizable*/true, /*maximizable*/true, /*minimizeOnClose*/false);
    ...
    var runObject = httpJsonpAsynchronous(undefined, function() {
        initAutocomplete();
        initMap();
    ...
    }, undefined, 10000, undefined, true, true);

...
websocket.addEventListener('message', function(e){
    ...
    function getVideoPm(username)
    {

        if (username != userInformation.name)
        {
            var jObject = {};
            jObject.type = 'video_pm';
            jObject.other_username = username;
            jObject.username = userInformation.name;
            websocket.send(jObject);
        }
    }

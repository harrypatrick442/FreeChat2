...
function Drag(element, handle, minX, maxX, minY, maxY, callback, callbackStarted) {
    ...
    function onDown(x, y)
    {
        if((state==0)&&callbackStarted)callbackStarted();
...
this.unmaximize=function(obj, maintainDragPositionInProportion){
    unmaximize(obj, maintainDragPositionInProportion);
};
...
this.Button = function(callback, imageSource, imageSourceHover)
{
    ...
    function unmaximize(obj, maintainDragPositionInProportion)
    {
        var windowInformation = obj.windowInformation;
        if(windowInformation.previousSizes)
        {
            if(!maintainDragPositionInProportion)
            ...
            setWindowSizePosition(obj, windowInformation.previousSizes.width, windowInformation.previousSizes.height);
            }   
        }
